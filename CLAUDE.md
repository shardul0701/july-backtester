...
## Forward Testing — Capital Isolation Policy (issue #162)

`forward_test_mode` config section controls how capital is divided across strategies in forward (paper) trading.
...
**Model A — isolated (default):** each strategy gets a fixed dollar slice. Backtest P&L maps 1:1 to forward P&L. This is the only implemented model.
